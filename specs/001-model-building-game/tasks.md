...
- [X] T046 Manual smoke test per `quickstart.md`: verify SC-003 (part placement visual update within 200 ms), SC-005 (first load < 3 s), SC-004 (progress restore < 5 s), SC-006 (zero-tutorial first completion)
